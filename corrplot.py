...
if __name__ == "__main__":
    X1 = np.load('feature/v6/X_DWI_transverse.npy')
    X2 = np.load('feature/v6/X_DWI_sagittal.npy')
    X3 = np.load('feature/v6/X_DWI_coronal.npy')
    X4 = np.load('feature/v6/X_T1+c_transverse.npy')
    X5 = np.load('feature/v6/X_T1+c_sagittal.npy')
    X6 = np.load('feature/v6/X_T1+c_coronal.npy')
    X7 = np.load('feature/v6/X_T2_transverse.npy')
    X8 = np.load('feature/v6/X_T2_sagittal.npy')
    X9 = np.load('feature/v6/X_T2_coronal.npy')
    X10 = np.load('feature/v6/X_T2-FLAIR_transverse.npy')
    X11 = np.load('feature/v6/X_T2-FLAIR_sagittal.npy')
    X12 = np.load('feature/v6/X_T2-FLAIR_coronal.npy')
    ...
    f, ax = plt.subplots()
    sns.heatmap(corrmat, square=True, cmap="rainbow", vmax=1, xticklabels=False,
                yticklabels=False)
    plt.show()
